...
from utils.sham_element import ShamElement
...
class BasePage(object):
    ...
    def swipe_up_ele(self, element, steps=10):
        """
        swipe up
    ...
    def screen_swipe_left(self, a, b, c, steps):
        """向左侧滑动"""
    ...
    def screen_swipe_right(self, a, b, c, steps):
        """向右侧滑动"""
        screen = self.get_size()
        x1 = int(screen[0] * a)
        y1 = int(screen[1] * b)
    ...
    def screen_swipe_up(self, a, b, c, steps):
        """向上滑动"""
        screen = self.get_size()
        x1 = int(screen[0] * a)
        y1 = int(screen[1] * b)
    ...
    def screen_swipe_down(self, a, b, c, steps):
        """向下滑动"""
        screen = self.get_size()
        x1 = int(screen[0] * a)
        y1 = int(screen[1] * b)
