...
class ScreenShot:
    def __init__(self, driver):
        self.driver = driver
        self.screen_path = r"/Users/work/test_IOS/storges/test_report/screen_shot/"
    ...
    def screenshot(self, element):
        ...
        self.get_screenshot_by_element(element).write_to_file(self.screen_path, 'img')
        os.path.isfile(self.screen_path + 'img')
        return self.screen_path + 'img'
